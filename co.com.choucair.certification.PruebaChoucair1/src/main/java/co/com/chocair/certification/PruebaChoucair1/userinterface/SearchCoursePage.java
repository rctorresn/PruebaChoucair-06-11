package co.com.chocair.certification.PruebaChoucair1.userinterface;
...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target BUTTON_GO = Target.the("Da click para buscar el curso").located(By.id("//[@class='btn btn-secondary']"));
